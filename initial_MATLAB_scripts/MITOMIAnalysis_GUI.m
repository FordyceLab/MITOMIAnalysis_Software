function varargout = MITOMIAnalysis_GUI(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @MITOMIAnalysis_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @MITOMIAnalysis_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function MITOMIAnalysis_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
uiwait(handles.figure_MITOMIAnalysis);



% --- Outputs from this function are returned to the command line.
function [] = MITOMIAnalysis_GUI_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    delete(handles.figure_MITOMIAnalysis);
end
